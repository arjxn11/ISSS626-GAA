...
We see a significantly higher portion of the black line outside the shaded region, it seems as if there is more clustering of childcare services in this region than there would be in a randomly distributed region. We have sufficient evidence to reject the null hypothesis and can conclude that the distribution of childcare services in Punggol is not random.
