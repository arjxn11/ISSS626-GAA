...
We will now import the Shape-file using the **st_read()** function of the **sf** package.
...
Given our area of focus is the Bangkok metropolitan

## Thailand Subnational Administrative Boundaries

We implement the st_read() function of the sf package to load to import the data-frame.
